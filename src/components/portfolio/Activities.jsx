export function ActivityCol({ title, items, isDark }) {
...
export function Activities({ organizations, committees, competitions, isDark }) {
  return (
    <section id="activities" className="py-28 px-6 md:px-8">
      <div className="max-w-[1100px] mx-auto">
        ...
        <h2 className="reveal font-serif text-[clamp(1.8rem,3.5vw,2.8rem)] tracking-tight mb-12 text-customText-light dark:text-customText-dark">
          Organisasi & <em className="text-brand dark:text-[#7ab84a] not-italic">kepanitiaan</em>
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          
          <ActivityCol title="Organisasi" items={organizations} isDark={isDark} />
          
          <ActivityCol title="Kepanitiaan" items={committees} isDark={isDark} />
