...
export const INITIAL_DATA = {
  ...
  skills: {
    frontend: [
      ...
      { name: "Figma", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg", featured: false },
    ],
    backend: [
...
export const loadData = () => {
  try {
    ...
    if (raw) {
      // Merge keys to preserve defaults if schema expands
      ...
      return {
        ...
        skills: { ...INITIAL_DATA.skills, ...parsed.skills },
      };
    }
  } catch (e) {
